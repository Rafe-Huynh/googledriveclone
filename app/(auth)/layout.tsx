  ...
  return (
    <div className='flex min-h-screen'>
        <section className='bg-brand p-10 hidden w-1/2 items-center justify-center lg:flex xl:w-2/5'>
            <div className='flex max-h-[800px] max-w-[430-px] flex-col justify-center space-y-12' >
                <Image src="/assets/icons/logo-full.svg" alt="logo" width={224} height={224} className='h-auto'/>
